...
const pages = [
  { title: "Home", path: "/" },
  { title: "Populares", path: "/most_popular" },
  { title: "Próximos lanzamientos", path: "/upcoming" },
];
    ...
    <AppBar position="static" sx={{ backgroundColor: "#1A120B" }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
            ...
            >
              {pages.map((page) => (
                <Link
                  key={page.title}
                  to={page.path}
                  style={{ textDecorationColor: "#28DF99" }}
                >
                  <MenuItem
                    key={page.title}
          ...
          >
            <IconButton sx={{ p: 0, mx: isMobile ? 2 : 7 }}>
              <Link to="/search">
                <Search
                  sx={{
                    color: "#3dd6a8",
